...
dataset  = load_dataset("audiofolder", data_dir="other_noise_final/") # CONVERT RECORDINGS AND TRANSCRIPTIONS INTO A DATASET READABLE FOR HUGGING FACE MODELS
...
model = AutoModelForCTC.from_pretrained("facebook/wav2vec2-base-960h",
    #"/scratch/s5505925/thesis_noiserobustASR/MODEL_libricarnoise/checkpoint-8000",
    ctc_loss_reduction="mean",
    pad_token_id=processor.tokenizer.pad_token_id,
)

training_args = TrainingArguments(
    output_dir="MODEL_libricarnoise_other",    #### Change
